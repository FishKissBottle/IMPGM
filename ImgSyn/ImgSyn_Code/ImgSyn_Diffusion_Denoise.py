...
from IMPGM_Inference_Helpers import run_imgsyn_diffusion_denoise
...
def ImgSyn_Diffusion_Denoise(
    ...
    decoded, latent = run_imgsyn_diffusion_denoise(
        sampler_mode=sampler_mode,
        prompt_str=prompt_str,
        fg_imgs_e=fg_imgs_e,
        model_builder=lambda: ImgSyn_Diffusion_UNet(
            ch=MODEL_CH,
            out_ch=MODEL_OUT_CH,
